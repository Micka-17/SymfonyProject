...
const challengeDefender = {
    Fr: "Full run !",
    Sk:"SpawnKill !",
    Reinforcement:"Reinforcement of walls is prohibited !",
    OWW:"Open walls and windows !",
    SO:"Secondary only !",
    NS:"No scop !",
    Suppressor:"Suppressor !",
    NG:"No gadgets !",
    HS:"Hide and seek !",
    TK:"TK act like you didn't do it on purpose !!!!!!",
    WP:"SMG",
    WP:"Light Machine Guns",
    WP:"Marksman Rifles",
    WP:"Shotgun !"
};
...
//
//Challenge
const dChallenge = Object.keys(challengeDefender).values
const defenderChallenge = dChallenge[Math.floor(Math.random()*dChallenge.length)];
console.log(defenderChallenge);
