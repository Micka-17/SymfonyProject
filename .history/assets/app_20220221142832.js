...
if(challengeAttacker === "SMG" || challengeAttacker === "Light Machine Guns" || challengeAttacker === "Marksman Rifles" || challengeAttacker === "Shotgun !") {
    attack.innerHTML = `${html}`;
    idAttackerer.innerHTML = "Choose a character!";
}
//
})
////////////